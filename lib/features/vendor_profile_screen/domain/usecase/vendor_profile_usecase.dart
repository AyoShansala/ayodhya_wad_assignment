...
class VendorProfileUsecase implements UseCase<VendorProfileEntity, NoParams> {
  ...
  @override
  Future<Either<Failure, VendorProfileEntity>> call(NoParams param) async {
    return await vendorProfileRepository.getVendor();
  }
}
