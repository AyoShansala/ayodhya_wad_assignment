...
import '../../domain/entity/coupon_entity/coupon_packages_data_entity.dart';
import '../../domain/entity/coupon_entity/coupons_entity.dart';
import '../../domain/entity/coupon_entity/package_data_entity.dart';
    ...
    return CouponsEntity(
        ...
        couponDataEntity: List.from((coupons ?? []).map((data) {
          return CouponDataEntity(
            ...
            couponPackagesDataEntity: List.from((data.couponPackagesData ?? []).map((data) {
