...
class CouponCard extends StatelessWidget {
  ...
  final int maxSaving;
  const CouponCard({super.key, required this.id, required this.parentCompanyId, this.name = 'N/A', this.address = 'N/A', this.description = 'N/A', required this.proImg, required this.coverImg, this.maxSaving = -9999});
