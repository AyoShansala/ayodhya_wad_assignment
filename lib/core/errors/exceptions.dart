...
class ServerException implements Exception {
  ...
  ServerException.fromDioError(DioException dioError) {
    ...
    switch (dioError.type) {
      case DioExceptionType.cancel:
        errorMessage = "'LocaleKeys.errors_server_requestCancelled.tr()'"; /* remove translation */
  ...
  String _handleStatusCode(Response? response) {
    ...
    switch (statusCode) {
      case 302:
        unexpectedError = true;
        return "'LocaleKeys.errors_server_redirectionFurtherActionNeedsToBeTakenInOrderToCompleteRequest.tr()'";
      case 400:
        unexpectedError = true;
      ...
      case 411:
        unexpectedError = true;
        return /* 'LocaleKeys.errors_server_companyNotFound.tr()' */ "An error occurred. Please try again later.";
      case 415:
        unexpectedError = true;
      ...
      case 423:
        unexpectedError = true;
        return /* 'LocaleKeys.features_bookings_close_booking_alreadyClosed.tr()' */ "An error occurred. Please try again later.";
      case 429:
        unexpectedError = true;
      ...
      case 433:
        unexpectedError = true;
        return /* 'LocaleKeys.errors_server_hasAnotherBooking.tr()' */ "An error occurred. Please try again later.";
      case 434:
        unexpectedError = true;
        return /* 'LocaleKeys.errors_server_hasClosedTime.tr()' */ "An error occurred. Please try again later.";
      default:
        unexpectedError = true;
